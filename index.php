                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                <label for="idVuelo" class="form-label">Id del vuelo</label>
                                <input type="number" name="edit_idVuelo" id="edit_idVuelo" class="form-control" placeholder="189" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="capacidad" class="form-label">Capacidad de Combustible</label>
                                <input type="text" name="edit_capacidad" id="edit_capacidad" class="form-control" placeholder="323,546 litros" required>
                            </div>


                            <div class="col-12 mb-3">
                                <label for="emision" class="form-label">Emision de carbono</label>
                                <input type="text" name="edit_emisionCarbono" id="edit_emisionCarbono" class="form-control" placeholder="161 kg" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="nAsientos" class="form-label">Numero de asientos</label>
                                <input type="number" name="edit_nAsientos" id="edit_nAsientos" class=" form-control" placeholder="300" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="aeropuertoActual" class="form-label">Aeropuerto en el que se encuentra actualmente</label>
                                <input type="text" name="edit_aeropuertoActual" id="edit_aeropuertoActual" class=" form-control" placeholder="aeropuerto Internacional Abraham González" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="velocidad" class="form-label">Velocidad</label>
                                <input type="text" name="edit_velocidad" id="edit_velocidad" class=" form-control" placeholder="400 km/h" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-check-label" for="edit_pantallas">Tiene pantallas?</label>
                                <input class="form-check-input" type="checkbox" name="edit_pantallas" id="edit_pantallas">
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('.editButton').on('click', function() {
                ...
                // $('#no').val(data[1]);
                $('#edit_idVuelo').val(data[1]);
                $('#edit_capacidad').val(data[2]);
                $('#edit_emisionCarbono').val(data[3]);
                // jenis kelamin checked

                $('#edit_nAsientos').val(data[4]);
                $('#edit_aeropuertoActual').val(data[5]);
                $('#edit_velocidad').val(data[6]);
                var edit = data[7]
                if(edit == 1){
                    $('#edit_pantallas').attr('checked',true);
                }else{
                    $('#edit_pantallas').attr('checked',false);
                }
